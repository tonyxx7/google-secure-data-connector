...
# Application
APP_NAME="dataconnector"
APP_LONG_NAME="Google Secure Data Connector"

# Wrapper
WRAPPER_CMD="/opt/dataconnector/third-party/java-service-wrapper/linux/bin/wrapper"
WRAPPER_CONF="/etc/opt/dataconnector/jsw/wrapper.conf"
