...
public class ClientConf {
  ...
  //ServiceApi state exporter.
  private static final String SERVICE_API_PORT_KEY = "serviceApiPort";
  private Integer serviceApiPort;
  ...
  public ClientConf(final Properties clientProps) throws ConfigurationException {
    ...
    serviceApiPort = getAndCheckIntegerProperty(clientProps, SERVICE_API_PORT_KEY, 0);
  ...
  /**
   * Retrieves the specified property from the given {@link Properties} instance and defaults to
   * defaultValue if null. This version allows the setting of a defaultValue for  properties that
   * are not required.  
   * 
   * @param props the properties instance to get the value from.
   * @param keyName the key to fetch.
   * @param defaultValue value to set if not found.
   * @return Integer representing the value of the property.
   * @throws ConfigurationException if the property is non existent.
   */
  static Integer getAndCheckIntegerProperty(final Properties props, final String keyName, 
      final Integer defaultValue) throws ConfigurationException {
    String stringIntValue = props.getProperty(keyName);
    stringIntValue = flags.getOptionValue(keyName, stringIntValue);
  ...
  public Integer getServiceApiPort() {
