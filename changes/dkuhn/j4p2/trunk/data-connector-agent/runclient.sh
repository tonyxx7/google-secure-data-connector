...
export CLASSPATH=\
$WOODSTOCK_HOME/third-party/jsocks/jsocks-server.jar:\
...
$WOODSTOCK_HOME/classes/
JVM_ARGS="-Djava.net.preferIPv4Stack=true"   

while /bin/true; do
  java com.google.dataconnector.client.Client \
  -localConfigFile /etc/opt/dataconnector/localConfig.xml \
  -rulesFile /etc/opt/dataconnector/resourceRules.xml
  sleep 5
  echo "RECONNECTING..."
done
