 ...
 */
public class SecureLinkConnection {

  // Logging instance
  private static final Logger log = Logger.getLogger(SecureLinkConnection.class);
   ...
   */
  public SecureLinkConnection(final ClientConf clientConf,
