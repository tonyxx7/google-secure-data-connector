...
public class FakeResourceRuleConfig {
  ...
  // Resource Values
  private static final String HTTP_NAME = "1";
  private static final String CLIENT_ID = "all";
  private static final String[] ALLOWED_ENTITY = 
      { "rcolline@test.joonix.net", "admin@test.joonix.net" };
  private static final String[] APPID = { "someappid", "someappid2" };
  private static final String HTTP_PATTERN = "http://www.example.com";
  private static final String SOCKET_NAME = "2";;
  private static final String SOCKET_PATTERN = "socket://128.195.131";
  private static final String HTTP_PROXY_PORT = "19233";
  private static final String SOCKS_SERVER_PORT = "1080";
  private static final String SECRET_KEY = "23423432432";
