...
import com.google.dataconnector.registration.v1.testing.ClientConf;
...
public class RegistrationRequest {
  ...
  // we use the old layout when there was only one protocol version.
  private static final String V1_SOCKET_ENTRY_NAME = 
      "com.google.dataconnector.util.SocketResourceConfigEntry";
  private static final String V1_URL_ENTRY_NAME = 
      "com.google.dataconnector.util.UriResourceConfigEntry";
   ...
   * @throws ResourceException if the data within the socket resources is invalid.
   */
   ...
   * @throws JSONException if any invalid or incorrectly formulated JSON is encountered
   * @throws ResourceException if the data within the uri resources is invalid.
   */
