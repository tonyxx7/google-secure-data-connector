...
public class ClientRegistrationUtil {
  ...
  public static AuthRequest authorize(final Socket socket, 
    ...
    log.info("Attempting login for " + localConfiguration.getUser() + "@" + 
    ...
    try {
      ...
      authRequest.setUser(localConfiguration.getUser());
      authRequest.setDomain(localConfiguration.getDomain());
      ...
      authRequest.setPassword(localConfiguration.getPassword());
