...
import com.google.dataconnector.registration.v1.ResourceException;
...
public class ClientConf {
   ...
   * @throws ResourceException if either of the above 2 are not found
   */
  public static String[] parseResourceRule(String resourceRule) throws ResourceException {
    String[] resourceStr = resourceRule.split("[\\s]+", 2);
    if (resourceStr.length < 2) {
      throw new ResourceException("Expected but not found both pattern & allowed entities " +
